...
export const loadCities = createAction('[City] Load Cities', props<{ countryId: number }>());
...
export const addCitySuccess = createAction('[City] Add City Success', props<{ city: City }>());
