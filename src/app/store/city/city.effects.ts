  ...
  constructor(
    ...
    this.loadCities$ = createEffect(() =>
      this.actions$.pipe(
        ...
        mergeMap((action) =>
          this.http.get<City[]>(`https://furious-rheba-davidmd-7455146e.koyeb.app/api/cities/${action.countryId}`).pipe(
    ...
    this.addCity$ = createEffect(() =>
      this.actions$.pipe(
        ...
        mergeMap((action) =>
          this.http.post<City>("https://furious-rheba-davidmd-7455146e.koyeb.app/api/city", action.city).pipe(
